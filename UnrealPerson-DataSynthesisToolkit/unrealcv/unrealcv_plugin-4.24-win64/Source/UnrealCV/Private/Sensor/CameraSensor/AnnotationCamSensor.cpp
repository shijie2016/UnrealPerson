...
void UAnnotationCamSensor::InitTextureTarget(int FilmWidthx, int FilmHeightx)
{
	EPixelFormat PixelFormat = EPixelFormat::PF_B8G8R8A8;
	bool bUseLinearGamma = true;
	TextureTarget->InitCustomFormat(FilmWidthx, FilmHeightx, PixelFormat, bUseLinearGamma);
}
