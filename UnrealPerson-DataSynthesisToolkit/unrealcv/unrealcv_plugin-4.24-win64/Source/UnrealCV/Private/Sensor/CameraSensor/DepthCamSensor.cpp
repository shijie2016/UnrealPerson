...
void UDepthCamSensor::InitTextureTarget(int FilmWidthx, int FilmHeightx)
{
	EPixelFormat PixelFormat = EPixelFormat::PF_FloatRGBA;
	bool bUseLinearGamma = true;
 	TextureTarget->InitCustomFormat(FilmWidthx, FilmHeightx, EPixelFormat::PF_FloatRGBA, bUseLinearGamma);
}
